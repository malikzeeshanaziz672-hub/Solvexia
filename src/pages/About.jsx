  ...
  return (
    <div className="min-h-screen pt-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1">
              ...
              <p className="text-lg text-gray-700 mb-4 leading-relaxed">
                Founded in 2014, Solvexia began with a simple vision: to create furniture that
                doesn't just fill spaces, but transforms them into havens of comfort and style.
              </p>
              <p className="text-lg text-gray-700 mb-4 leading-relaxed">
                What started as a small workshop has grown into a trusted name in premium furniture,
                serving thousands of satisfied customers across the country. Our commitment to
                quality craftsmanship and timeless design remains unchanged.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                Every piece we create is a testament to our dedication to excellence, combining
                traditional techniques with modern innovation to deliver furniture that stands the
                test of time.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              >
                <div className={`inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br ${value.color} text-white mb-6 transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 shadow-lg`}>
                  <value.icon size={36} />
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-amber-700 to-amber-900 rounded-3xl p-12 text-white text-center">
            ...
            <p className="text-xl text-amber-100 max-w-3xl mx-auto leading-relaxed">
              To enhance the quality of life by creating exceptional furniture that brings comfort,
              style, and joy to homes around the world. We believe that great furniture is more than
              just functional—it's an investment in your daily happiness and well-being.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold text-gray-900 mb-4">By The Numbers</h2>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              >
                <div className="text-5xl font-bold text-amber-600 mb-2">{stat.number}</div>
